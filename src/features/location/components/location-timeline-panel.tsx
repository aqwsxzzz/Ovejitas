...
import { LocationEventForm } from "@/features/location/components/location-event-form";
import { useLocationActions } from "@/features/location/hooks/use-location-actions";

interface LocationTimelinePanelProps {
	farmId: string;
	locationId: string;
}
...
export function LocationTimelinePanel({
	...
	const actions = useLocationActions(farmId, locationId);
